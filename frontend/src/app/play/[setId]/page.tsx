    ...
    <div className="min-h-screen bg-background text-white flex flex-col items-center justify-center pt-24 px-4">
      <div className="w-full max-w-2xl text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href={`/play/${strSetId}/flashcards`} className="bg-gray-900 border border-gray-800 p-6 rounded-2xl hover:border-purple-600 hover:scale-105 transition-transform flex flex-col items-center">
            <FlashcardIcon />
          ...
          <Link href={`/play/${strSetId}/quiz`} className="bg-gray-900 border border-gray-800 p-6 rounded-2xl hover:border-purple-600 hover:scale-105 transition-transform flex flex-col items-center">
            <QuizIcon />
